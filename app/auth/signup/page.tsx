    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <h1 className="font-heading font-black text-3xl text-slate-900 mb-2">Join our community</h1>
          <p className="font-body text-slate-600">
            Create an account to start sharing your insights and engaging with diverse voices.
          </p>
        </div>
        <SignUpForm />
      </div>
